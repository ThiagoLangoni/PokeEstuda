package br.com.thiagolangoni.pokeestuda.view.list
...
import br.com.thiagolangoni.pokeestuda.view.form.FormPokemonsActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listPokemonsViewModel.pokemons.observe(this, Observer {
            rvPokemons.adapter = ListPokemonsAdapter(it, picasso) {
                val intent = Intent(this, FormPokemonsActivity::class.java)
